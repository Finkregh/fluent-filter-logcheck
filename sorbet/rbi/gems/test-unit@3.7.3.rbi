...
#   end
#
# source://test-unit//lib/test/unit/assertions.rb#38
module Test::Unit::Assertions
  ...
  # @return [void]
  #
  # source://test-unit//lib/test/unit/assertions.rb#1928
  def add_assertion; end

  # @overload assert
  # @overload assert
  #
  # source://test-unit//lib/test/unit/assertions.rb#129
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1582
  def assert_alias_method(object, alias_name, original_name, message = T.unsafe(nil)); end

  # @overload assert_all
  # @since 3.4.4
  #
  # source://test-unit//lib/test/unit/assertions.rb#1792
  ...
  # @since 3.4.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#1818
  def assert_all?(collection, message = T.unsafe(nil)); end
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#48
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1353
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1402
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1497
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1727
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#220
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1435
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1385
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#922
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1084
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1666
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#1683
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#386
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#473
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#596
  ...
  #   assert_nil [1, 2].uniq!
  #
  # source://test-unit//lib/test/unit/assertions.rb#457
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#793
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1514
  ...
  #   assert_not_empty({})                       # -> fail
  #
  # source://test-unit//lib/test/unit/assertions.rb#1750
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#735
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#966
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1145
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1693
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1710
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#422
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#511
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#752
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#653
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1553
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#569
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#715
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1318
  def assert_not_send(send_array, message = T.unsafe(nil)); end

  # @overload assert_nothing_leaked_memory
  # @since 3.4.5
  #
  # source://test-unit//lib/test/unit/assertions.rb#1866
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#678
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#898
  ...
  #   assert_operator 5, :>=, 4
  #
  # source://test-unit//lib/test/unit/assertions.rb#630
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1629
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1647
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1531
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#264
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#361
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1459
  ...
  # @since 3.4.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#313
  ...
  #   assert_raise(RuntimeError.new("ZZZ")) {raise "XXX"} # -> fail
  #
  # source://test-unit//lib/test/unit/assertions.rb#286
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#546
  ...
  #   assert_same o, o
  #
  # source://test-unit//lib/test/unit/assertions.rb#613
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1278
  ...
  #   end
  #
  # source://test-unit//lib/test/unit/assertions.rb#852
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#889
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1369
  ...
  # the template.
  #
  # source://test-unit//lib/test/unit/assertions.rb#1899
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#706
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#186
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1766
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#745
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#1004
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1192
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#450
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#539
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#783
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#762
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#669
  ...
  # @since 3.0.0
  #
  # source://test-unit//lib/test/unit/assertions.rb#1572
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#589
  ...
  # @since 2.5.3
  #
  # source://test-unit//lib/test/unit/assertions.rb#728
  def refute_same(expected, actual, message = T.unsafe(nil)); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#1023
  ...
  # source://test-unit//lib/test/unit/assertions.rb#1007
  def _assert_in_delta_validate_arguments(expected_float, actual_float, delta); end

  # source://test-unit//lib/test/unit/assertions.rb#1211
  ...
  # source://test-unit//lib/test/unit/assertions.rb#1195
  ...
  # source://test-unit//lib/test/unit/assertions.rb#1968
  def _set_failed_information(failure, expected, actual); end

  # source://test-unit//lib/test/unit/assertions.rb#1905
  ...
  class << self
    ...
    #
    # source://test-unit//lib/test/unit/assertions.rb#1934
...
class Test::Unit::Assertions::AssertExceptionHelper
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2427
  def initialize(test_case, expected_exceptions); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2449
  def expected?(actual_exception, equality = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/assertions.rb#2434
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2493
  def exception_class?(exception_type); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2483
  def exception_object?(exception_type); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2503
  def expected_class?(actual_exception, equality); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2509
  def expected_module?(actual_exception); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2515
  def expected_object?(actual_exception); end

  # source://test-unit//lib/test/unit/assertions.rb#2522
...
# source://test-unit//lib/test/unit/assertions.rb#2389
class Test::Unit::Assertions::AssertExceptionHelper::WrappedException
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2390
  def exception; end

  # source://test-unit//lib/test/unit/assertions.rb#2395
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2410
...
# source://test-unit//lib/test/unit/assertions.rb#1975
class Test::Unit::Assertions::AssertionMessage
  include ::Test::Unit::Util::BacktraceFilter

  # @return [AssertionMessage] a new instance of AssertionMessage
  #
  # source://test-unit//lib/test/unit/assertions.rb#2350
  def initialize(user_message, template_string, parameters); end

  # source://test-unit//lib/test/unit/assertions.rb#2356
  def convert(object); end

  # source://test-unit//lib/test/unit/assertions.rb#2360
  def template; end

  # source://test-unit//lib/test/unit/assertions.rb#2371
  def to_s; end
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2383
  def add_period(string); end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2066
    def convert(object); end

    # source://test-unit//lib/test/unit/assertions.rb#2043
    def delayed_diff(from, to); end

    # source://test-unit//lib/test/unit/assertions.rb#1984
    def delayed_literal(&block); end

    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2012
    ...
    # source://test-unit//lib/test/unit/assertions.rb#2008
    ...
    #
    # source://test-unit//lib/test/unit/assertions.rb#1978
    def use_pp; end
...
# source://test-unit//lib/test/unit/assertions.rb#2230
class Test::Unit::Assertions::AssertionMessage::ArrayInspector
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2262
  def each(&block); end

  # source://test-unit//lib/test/unit/assertions.rb#2246
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2250
  ...
  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2234
...
class Test::Unit::Assertions::AssertionMessage::DelayedLiteral
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2278
...
class Test::Unit::Assertions::AssertionMessage::HashInspector
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2218
  def each_pair; end

  # source://test-unit//lib/test/unit/assertions.rb#2195
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2199
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2214
  def pretty_print_cycle(q); end

  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2180
    def target?(object); end
  end
end

# source://test-unit//lib/test/unit/assertions.rb#2086
class Test::Unit::Assertions::AssertionMessage::Inspector
  include ::Comparable

  # @return [Inspector] a new instance of Inspector
  #
  # source://test-unit//lib/test/unit/assertions.rb#2110
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2139
  def inspect_target; end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2090
    def cached_new(object, inspected_objects); end

    # source://test-unit//lib/test/unit/assertions.rb#2096
    def inspector_classes; end

    # source://test-unit//lib/test/unit/assertions.rb#2100
...
class Test::Unit::Assertions::AssertionMessage::Literal
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2268
  def initialize(value); end
...
class Test::Unit::Assertions::AssertionMessage::MaybeContainer
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2288
...
# source://test-unit//lib/test/unit/assertions.rb#2149
class Test::Unit::Assertions::AssertionMessage::NumericInspector
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2167
  def pretty_print(q); end
  ...
  class << self
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#2153
    def target?(object); end
  end
end

# source://test-unit//lib/test/unit/assertions.rb#2305
class Test::Unit::Assertions::AssertionMessage::Template
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2339
  def concatenatable(text, encoding); end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2306
...
# @private
#
# source://test-unit//lib/test/unit/assertions.rb#61
Test::Unit::Assertions::NOT_SPECIFIED = T.let(T.unsafe(nil), Object)

# @private
#
# source://test-unit//lib/test/unit/assertions.rb#803
class Test::Unit::Assertions::ThrowTagExtractor
  # @return [ThrowTagExtractor] a new instance of ThrowTagExtractor
  #
  # source://test-unit//lib/test/unit/assertions.rb#812
  def initialize(error); end

  # source://test-unit//lib/test/unit/assertions.rb#816
  def extract_tag; end

  private

  # source://test-unit//lib/test/unit/assertions.rb#831
  def normalize_tag(tag); end
end

# source://test-unit//lib/test/unit/assertions.rb#806
...
module Test::Unit::Util::BacktraceFilter
  ...
  # source://test-unit//lib/test/unit/util/backtracefilter.rb#26
...
# source://test-unit//lib/test/unit/util/backtracefilter.rb#16
...
# source://test-unit//lib/test/unit/util/backtracefilter.rb#18
