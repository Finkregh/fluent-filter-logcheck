...
#
# source://rubocop-packaging//lib/rubocop/packaging/plugin.rb#8
class RuboCop::Packaging::Plugin < ::LintRoller::Plugin
  # source://rubocop-packaging//lib/rubocop/packaging/plugin.rb#9
  def about; end

  # source://rubocop-packaging//lib/rubocop/packaging/plugin.rb#22
  def rules(_context); end

  # @return [Boolean]
  #
  # source://rubocop-packaging//lib/rubocop/packaging/plugin.rb#18
